...
const Contact = () => {
    useDocTitle('Shri Siddheshwar Sales & Services');
                        ...
                        <div className="flex flex-col text-white">
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">1171, Prachiti, Malkapur Road, Bambavade</p>
                                </div>
                            </div>
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">+91 9923827273</p>
                                    <div className='mt-5'>
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">siddheshwarsales73@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
